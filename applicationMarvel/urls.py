...
urlpatterns += patterns('',
                        ...
                        url(r'^api/creators/$', APICreatorList.as_view(), name='api_creator_list'),
                        url(r'^api/creator/(?P<pk>\d+)/$', APICreatorDetail.as_view(), name='api_creator_detail'),
                        url(r'^api/stories/$', APIStoryList.as_view(), name='api_stories_list'),
                        url(r'^api/story/(?P<pk>\d+)/$', APIStoryDetail.as_view(), name='api_story_detail'),
                        url(r'^api/comics/$', APIComicList.as_view(), name='api_comics_list'),
                        url(r'^api/comic/(?P<pk>\d+)/$', APIComicDetail.as_view(), name='api_comic_detail'),
                        url(r'^api/characters/$', APICharacterList.as_view(), name='api_characters_list'),
                        url(r'^api/character/(?P<pk>\d+)/$', APICharacterDetail.as_view(), name='api_character_detail'),
                        url(r'^api/events/$', APIEventList.as_view(), name='api_events_list'),
                        url(r'^api/event/(?P<pk>\d+)/$', APIEventDetail.as_view(), name='api_event_detail'),
                        )